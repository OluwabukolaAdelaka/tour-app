...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center w-full justify-between px-4 h-20 absolute text-white z-10'>
        ...
        <div onClick={handleNav} className='md:hidden z-10'>
            {nav ? <AiOutlineClose className='text-black' size={20}/> : <RiMenu4Fill size={20}/>}
        </div>

      {/* mobile menu */}
      {/* 'absolute left-0 top-0 w-full bg-gray-100/90 py-6 px-4' */}
      <div className={nav ? 'absolute left-0 top-0 w-full bg-gray-100/90 text-black py-6 px-4' : 
      'absolute left-[-100%]'}>
          <ul>
